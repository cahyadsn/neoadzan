...
================================================================================
FILENAME     : getDistrict.php
PURPOSE      : API for getting district list
AUTHOR       : CAHYA DSN
...
if(isset($_GET['id']) && !empty($_GET['id'])){
	$query = $db->prepare("SELECT kode, nama FROM {$dbtable} WHERE LEFT(kode,2)=:id AND CHAR_LENGTH(kode)=5 ORDER BY kode");
